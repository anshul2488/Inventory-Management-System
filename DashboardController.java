...
public class DashboardController implements Initializable{
    ...
    void showRent(ActionEvent event) {
        try {
            ...
            Parent rentList = FXMLLoader.load(getClass().getResource("/project/resources/view/rentallist.fxml"));
    ...
    void showSell(ActionEvent event) {
        try {
            ...
            Parent sellsList = FXMLLoader.load(getClass().getResource("/project/resources/view/selllist.fxml"));
