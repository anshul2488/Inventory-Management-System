...
import project.java.others.Customer;
...
public class CustomerController implements Initializable {
    ...
    private void recordNavigator() {
        ...
        if (onView.getPhoto() == null) {
            ImagePattern img = new ImagePattern(new Image("/project/resources/icons/user.png"));
    ...
    void showPurchases(ActionEvent event) {
        try {
            ...
            Parent pur = FXMLLoader.load(getClass().getResource("/project/resources/view/customerpurchase.fxml"));
    ...
    void showrentals(ActionEvent event) {
        try {
            ...
            Parent rent = FXMLLoader.load(getClass().getResource("/project/resources/view/customerrentals.fxml"));
    ...
    void btnSaveAction(ActionEvent event) {
        if (addFlag) {
            ...
            if(fieldsNotEmpty) {
                ...
                alert.setGraphic(new ImageView(this.getClass().getResource("/project/resources/icons/question (2).png").toString()));
