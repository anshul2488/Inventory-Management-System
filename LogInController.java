...
public class LogInController implements Initializable{
    ...
    private static final String DIALOG_URL = "/project/resources/view/dialog.fxml";
        ...
        if (username.equals("")) {
            ...
            try {
                ...
                if (rs.next()) {
                    ...
                    try {
                        root = FXMLLoader.load(getClass().getResource("/project/resources/view/initializer.fxml"));
