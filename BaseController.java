package project.java.controllers;
...
public class BaseController implements Initializable{
    ...
    private void loadFXMLMap() {
        ...
        FXML_URL.put("Dashboard", "/project/resources/view/login.fxml");
        FXML_URL.put("Items", "/project/resources/view/inventory.fxml");
        FXML_URL.put("Customers", "/project/resources/view/customer.fxml");
        FXML_URL.put("Dashboard", "/project/resources/view/dashboard.fxml");
        FXML_URL.put("Sells", "/project/resources/view/sells.fxml");
        FXML_URL.put("Rentals", "/project/resources/view/rentals.fxml");
        FXML_URL.put("Accounts", "/project/resources/view/accounts.fxml");
        FXML_URL.put("Administrative", "/project/resources/view/administrator.fxml");
        FXML_URL.put("Update Due", "/project/resources/view/dueupdate.fxml");
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        try {
            ctrlRightPane("/project/resources/view/dashboard.fxml");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    private void logOut() {
        ...
        try {
            ...
            Parent root = FXMLLoader.load(getClass().getResource("/project/resources/view/login.fxml"));
            root.getStylesheets().add("/project/resources/css/login.css");
