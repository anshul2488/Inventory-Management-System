...
import project.java.others.DBConnection;
...
public class AdministratorController implements Initializable {
    ...
    void accUpdate(ActionEvent event) {
        loadWindow("Account Management", "/project/resources/view/accountmanager.fxml");
    }

    @FXML
    void itemTypeManage(ActionEvent event) {
        loadWindow("Item Type Management", "/project/resources/view/itemtypemanager.fxml");
    }

    @FXML
    void addNewEmployee(ActionEvent event) {
        loadWindow("Add Employee", "/project/resources/view/newemployee.fxml");
    }
    ...
    void deleteAll(ActionEvent event) {
        ...
        try {
            ...
            alert.setGraphic(new ImageView(this.getClass().getResource("/project/resources/icons/x-button.png").toString()));
    ...
    void empList(ActionEvent event) {
        loadWindow("Employee Management", "/project/resources/view/employeelist.fxml");
    }


    @FXML
    void showTransactions(ActionEvent event) {
        loadWindow("Transaction List", "/project/resources/view/translist.fxml");
    }

    @FXML
    void totalRents(ActionEvent event) {
        SellListController.todayFlag = false;
        loadWindow("Rental List", "/project/resources/view/rentallist.fxml");
    }

    @FXML
    void totalSell(ActionEvent event) {
        SellListController.todayFlag = false;
        loadWindow("Sell List", "/project/resources/view/selllist.fxml");
    }
