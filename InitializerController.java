...
public class InitializerController implements Initializable {
    ...
    private void loadApplication() {
        ...
        try {
            root = FXMLLoader.load(getClass().getResource("/project/resources/view/base.fxml"));
            Scene scene = new Scene(root);
            String css = this.getClass().getResource("/project/resources/css/base.css").toExternalForm();
            scene.getStylesheets().add(css);
            base.setTitle("Inventory System");
            base.getIcons().add(new Image("/project/resources/icons/Logo.png"));
            base.setScene(scene);
